...
import { FinihScheduleController } from "./controllers/schedule/FinishScheduleController";
...
router.delete('/schedule', isAuthenticated, new FinihScheduleController().handle);
